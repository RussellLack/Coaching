...
const archetypes = [
  {
    ...
    description: "Leading organisations through AI-driven change whilst protecting your own judgement and authority.",
  },
  {
    id: "founder",
    label: "Founder / Operator",
    description: "Rebuilding your operating model around AI whilst retaining what made the business distinctively yours.",
  },
  {
    id: "consultant",
    label: "Independent Consultant",
    description: "Repositioning your expertise in a landscape where AI can replicate much of what you previously charged for.",
  },
  {
    id: "expert",
    label: "Deep Domain Expert",
    description: "Protecting the value of accumulated knowledge when AI systems appear to match your output.",
  },
];
...
const questions: Record<string, { q: string; options: string[] }[]> = {
  exec: [
    {
      q: "How confident are you that your judgement calls are genuinely irreplaceable by AI systems?",
      options: ["Very confident — I make decisions no model could make", "Uncertain — some decisions feel exposed", "Not sure — I haven't thought it through carefully"],
    },
    {
      q: "When your organisation adopts new AI tools, where does your authority tend to come from?",
      options: ["Experience and context that the tools lack", "Managing the people and politics around the tools", "I'm not sure my current authority is well-grounded"],
    },
    {
      q: "How clearly can you articulate your professional value in a world of capable AI?",
      options: ["Very clearly — I've thought this through", "I have a general sense but couldn't make it precise", "This is something I actively worry about"],
    },
  ],
  founder: [
    {
      q: "How much of your company's current value depends on things AI could replicate within two years?",
      options: ["Very little — our moat is human and relational", "Some parts are exposed, others are not", "More than I'm comfortable admitting"],
    },
    {
      q: "When you make key decisions, how much do you rely on instinct built up over years?",
      options: ["Heavily — that instinct is core to what I do", "I balance instinct with data and analysis", "I'm trying to rely on it less as tools improve"],
    },
    {
      q: "How clearly have you mapped which parts of your role should be automated versus protected?",
      options: ["I have a clear map and act on it", "I've thought about it but haven't been systematic", "This is work I haven't done yet"],
    },
  ],
  consultant: [
    {
      q: "How much of what you charge for could a well-prompted AI produce in a fraction of the time?",
      options: ["Very little — my value is relational and contextual", "Some deliverables are exposed, my judgement is not", "More than I'd like — I'm actively repositioning"],
    },
    {
      q: "When clients engage you, what are they primarily paying for?",
      options: ["Access to my judgement and accumulated experience", "Quality of output that AI hasn't matched yet", "Accountability, trust and ongoing relationship"],
    },
    {
      q: "How confident are you in the durability of your current positioning over the next three years?",
      options: ["Confident — I'm already repositioning well", "Moderately confident with some concerns", "This is a significant source of professional anxiety"],
    },
  ],
  expert: [
    {
      q: "How much of your expertise is tacit — held in judgement and pattern recognition rather than articulated knowledge?",
      options: ["Most of it — it can't easily be written down", "A good proportion, alongside formalised knowledge", "Mostly formalised — which makes me feel exposed"],
    },
    {
      q: "When AI systems produce outputs in your domain, how do you experience them?",
      options: ["Useful tools I can direct and critique confidently", "Occasionally impressive, occasionally wrong in subtle ways", "Threatening to the perception of my value"],
    },
    {
      q: "Have you articulated clearly to others why your expertise remains valuable in an AI-capable environment?",
      options: ["Yes — I can make this case compellingly", "I've tried but the message hasn't fully landed", "This is something I need to work on"],
    },
  ],
};

const journeys = [
  { title: "Value Clarity", description: "Identify precisely where your professional value is defensible and where it is exposed to AI substitution." },
  { title: "Authority Navigation", description: "Rebuild the foundations of your authority so they rest on what AI cannot replicate: judgement, trust and context." },
  { title: "Identity Transition", description: "Work through the professional identity questions that arise when your expertise appears less unique than it once felt." },
  { title: "Strategic Repositioning", description: "Define a clear professional narrative that holds in conversations with peers, clients and the organisations you lead." },
  { title: "Operating Model Reset", description: "Redesign how you work so AI augments your distinctiveness rather than displacing the craft you built your reputation on." },
  { title: "Sustained Accountability", description: "Maintain the momentum of change with ongoing challenge, reflection and professional accountability." },
];
  ...
  return (
    <main style={{ background: "var(--teal)", minHeight: "100vh" }}>
      ...
      <nav style={{ borderBottom: "1px solid rgba(255,255,255,0.08)", padding: "1.25rem 2rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <span style={{ fontFamily: "Helvetica Neue, Arial, sans-serif", fontWeight: 300, letterSpacing: "0.15em", fontSize: "0.85rem", color: "var(--cream)", textTransform: "uppercase" }}>Executive OS</span>
      ...
      <section style={{ maxWidth: "860px", margin: "0 auto", padding: "6rem 2rem 5rem" }}>
        ...
        <h1 style={{ fontSize: "clamp(2.2rem, 5vw, 3.8rem)", fontWeight: 400, lineHeight: 1.15, color: "var(--cream)", marginBottom: "2rem", letterSpacing: "-0.01em" }}>
          Your expertise is not in decline.<br />
          <em style={{ color: "rgba(245,240,235,0.6)", fontStyle: "italic" }}>Its context has changed.</em>
        </h1>
        <p style={{ fontFamily: "Helvetica Neue, Arial, sans-serif", fontSize: "1.1rem", lineHeight: 1.7, color: "rgba(245,240,235,0.75)", maxWidth: "600px", marginBottom: "2.5rem" }}>
          Executive OS is a private coaching practice for senior professionals navigating AI disruption. Not AI training. Not generic coaching. Precise, confidential work on identity, judgement and professional value.
        </p>
        ...
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "3rem" }}>
            {[
              ...
              { title: "Trust over time", body: "The coaching relationship builds something AI cannot manufacture: earned trust through sustained, honest professional engagement." },
            ].map(({ title, body }) => (
              <div key={title}>
      ...
      <section id="snapshot" style={{ padding: "5rem 2rem" }}>
        <div style={{ maxWidth: "700px", margin: "0 auto" }}>
          <p style={{ fontFamily: "Helvetica Neue, Arial, sans-serif", fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(245,240,235,0.4)", marginBottom: "1rem" }}>
            Free Snapshot
          </p>
          <h2 style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 400, color: "var(--cream)", marginBottom: "1rem" }}>
            Where do you stand?
          </h2>
          ...
          {selectedArchetype && !showResult && (
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2.5rem" }}>
                <span style={{ fontFamily: "Helvetica Neue, Arial, sans-serif", fontSize: "0.8rem", color: "rgba(245,240,235,0.4)" }}>
                  Question {currentQuestion + 1} of {questions[selectedArchetype].length}
                </span>
          ...
          {showResult && !showPaidPreview && (
            <div>
              ...
              <button
                onClick={() => setShowPaidPreview(true)}
              ...
              <button onClick={resetAssessment} style={{ display: "block", width: "100%", padding: "1rem", background: "transparent", color: "rgba(245,240,235,0.4)", border: "1px solid rgba(255,255,255,0.1)", fontFamily: "Helvetica Neue, Arial, sans-serif", fontSize: "0.8rem", cursor: "pointer", letterSpacing: "0.05em" }}>
                Start again
              </button>
            </div>
          )}
          ...
          {showPaidPreview && (
            <div>
              <div style={{ border: "1px solid rgba(227,66,52,0.3)", padding: "2.5rem", marginBottom: "2rem" }}>
                <p style={{ fontFamily: "Helvetica Neue, Arial, sans-serif", fontSize: "0.75rem", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--coral)", marginBottom: "1.5rem" }}>Deep Navigation Scan — £495</p>
                ...
                <div style={{ display: "grid", gap: "1rem", marginBottom: "1.5rem" }}>
                  {[
                    "Extended diagnostic across six professional dimensions",
                    "AI Navigation Brief: a written summary of your position, exposures and defensible strengths",
                    "Sample output from the diagnostic modules",
                    "Recommended coaching journey based on your specific profile",
                    "Private strategy session with your coach to work through the findings",
                  ].map((item) => (
      ...
      <section id="book" style={{ borderTop: "1px solid rgba(255,255,255,0.08)", padding: "5rem 2rem" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
          ...
          <h2 style={{ fontSize: "clamp(1.6rem, 3vw, 2.4rem)", fontWeight: 400, color: "var(--cream)", marginBottom: "1.25rem" }}>
          ...
          <a
            href="mailto:hello@fab.partners?subject=Executive OS — Strategy Session Request"
          ...
          <p style={{ fontFamily: "Helvetica Neue, Arial, sans-serif", fontSize: "0.8rem", color: "rgba(245,240,235,0.3)", marginTop: "1rem" }}>
      ...
      <footer style={{ borderTop: "1px solid rgba(255,255,255,0.08)", padding: "2.5rem 2rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
        <span style={{ fontFamily: "Helvetica Neue, Arial, sans-serif", fontSize: "0.8rem", color: "rgba(245,240,235,0.25)", letterSpacing: "0.1em", textTransform: "uppercase" }}>Executive OS</span>
